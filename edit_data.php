...
<div class="container-fluid">
        ...
        <input type="text" class="form-control" name="nim" placeholder="ID" autofocus="" disabled="" value="<?php echo $_GET['nim'];?>" />
        <input type="password" class="form-control" name="password" placeholder="Password"/> 
        <button class='btn btn-lg btn-primary btn-block'  name='add' value='Login' type='Submit'>EDIT DATA</button>";
        </form>  
